...
if TYPE_CHECKING:
    from .jax import FunctionalLocalOperatorJax


class FunctionalLocalOperator(LocalOperatorBase):
    ...
    def to_jax_operator(self) -> "FunctionalLocalOperatorJax":  # noqa: F821
        """
        ...
        return FunctionalLocalOperatorJax(
            self.hilbert,
            self.operators,
            self.acting_on,
            self.constant,
