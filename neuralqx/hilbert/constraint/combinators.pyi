...
class AndConstraint(AbstractDiscreteConstraint):
    constraints: tuple[AbstractDiscreteConstraint, ...]
    def __init__(
        self,
        constraints: Sequence[AbstractDiscreteConstraint],
    ) -> None: ...
...
class NotConstraint(AbstractDiscreteConstraint):
    ...
    def __init__(self, constraint: AbstractDiscreteConstraint) -> None: ...
    def __call__(self, states: Any) -> jnp.ndarray: ...
