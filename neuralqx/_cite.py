...
@software{neuralqx2026github,
  ...
  title = {{neuraLQX}: a high-performance simulations toolkit for variational loop quantum gravity},
...
""".strip(),
    ...
    _GROUPS: Dict[str, FrozenSet[str]] = {
        ...
        "jax": frozenset({"jax"}),
        "flax": frozenset({"flax"}),
        "all": frozenset({"neuralqx", "netket2", "netket3", "jax", "flax"}),
    }
