...
ValidatorLike = Callable[..., Any] | Sequence[Callable[..., Any]] | None

FlattenFn = Callable[[Any], tuple[Sequence[Any], Any]]

UnflattenFn = Callable[[Any, Sequence[Any]], Any]

FlattenWithKeysFn = Callable[[Any], tuple[Sequence[tuple[Any, Any]], Any]]
...
DeserializerFn = Callable[[Any], Any]
